import type { AuthLoginResponseSchema } from '@react-monorepo/rrouter/src/auth/apis/auth.api'
import type { UserStoreState } from '@react-monorepo/rrouter/src/auth/hooks/use-auth-user-store.hook'
